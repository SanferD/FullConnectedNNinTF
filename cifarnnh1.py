...
for factor in [2, 4, 8, 16]:
	# Network Paramters
	hidden1 = n_input/factor # number of hidden-layer feauters
	print ("Now processing with hidden layer: ", hidden1)
	...
	with tf.device('/gpu:0'):
		...
		W2, b2 = MakeWeightBias(n_classes)
		logits = WeightedOutput(layer1, W2, b2)
		...
		# SAVE #
		########
		name = FILE_NAME + "-h=" + repr(hidden1)
		title = "One hidden layer h1 where h1=" + repr(hidden1)
